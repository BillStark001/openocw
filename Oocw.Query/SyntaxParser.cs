...
public static class SyntaxParser
{
    ...
    static SyntaxParser()
    {
        ...
        {
            // M -> M,E | E,E
            D(SMBL_EXPR_MERGED, SMBL_EXPR_MERGED, L.TOKEN_COMMA, SMBL_EXPR),
            D(SMBL_EXPR_MERGED, SMBL_EXPR, L.TOKEN_COMMA, SMBL_EXPR),

            // S2 -> {M} | {M,} | {E} | {E,} | {} | E
            D(SMBL_EXPR_SET2, L.TOKEN_BRACKET_LS, SMBL_EXPR_MERGED, L.TOKEN_BRACKET_LE),
            D(SMBL_EXPR_SET2, L.TOKEN_BRACKET_LS, SMBL_EXPR_MERGED, L.TOKEN_COMMA, L.TOKEN_BRACKET_LE),
            D(SMBL_EXPR_SET2, L.TOKEN_BRACKET_LS, SMBL_EXPR, L.TOKEN_BRACKET_LE),
            D(SMBL_EXPR_SET2, L.TOKEN_BRACKET_LS, SMBL_EXPR, L.TOKEN_COMMA, L.TOKEN_BRACKET_LE),
            D(SMBL_EXPR_SET2, L.TOKEN_BRACKET_LS, L.TOKEN_BRACKET_LE),
            D(SMBL_EXPR_SET2, SMBL_EXPR),

            // O -> O.S2 | O(S2) | O(M) | O[S2] | O[M] | S2
            D(SMBL_EXPR_OOP, SMBL_EXPR_OOP, L.TOKEN_DOT, SMBL_EXPR_SET2),
            D(SMBL_EXPR_OOP, SMBL_EXPR_OOP, L.TOKEN_BRACKET_SS, SMBL_EXPR_SET2, L.TOKEN_BRACKET_SE),
            D(SMBL_EXPR_OOP, SMBL_EXPR_OOP, L.TOKEN_BRACKET_SS, SMBL_EXPR_MERGED, L.TOKEN_BRACKET_SE),
            D(SMBL_EXPR_OOP, SMBL_EXPR_OOP, L.TOKEN_BRACKET_MS, SMBL_EXPR_SET2, L.TOKEN_BRACKET_ME),
            D(SMBL_EXPR_OOP, SMBL_EXPR_OOP, L.TOKEN_BRACKET_MS, SMBL_EXPR_MERGED, L.TOKEN_BRACKET_ME),
            D(SMBL_EXPR_OOP, SMBL_EXPR_SET2),

            // MO -> !MO | ~MO | O
            // TODO add unary negative sign?
            D(SMBL_EXPR_MONO, L.TOKEN_OPR_L_NOT, SMBL_EXPR_MONO),
            D(SMBL_EXPR_MONO, L.TOKEN_OPR_A_NOT, SMBL_EXPR_MONO),
            D(SMBL_EXPR_MONO, SMBL_EXPR_OOP)
        };

    ...
    <ul class="navbar-inner">
      <li>
        <router-link class="item" to="/">
          <img src="../assets/svg/logo.svg"
            style="margin-right: 4px; height: 36px; position: relative; top: 12px;" />
      ...
      <li class="search-bar align-right" style="margin-right: 5px;">
        <div class="search-inner">
          <input type="search" class="search-input" v-model="searchText" v-on:keyup="triggerSearch"
            autocomplete="off" v-bind:placeholder="t('searchbar.search')"
            v-bind:aria-label="t('searchbar.search.hint')">
